...
class UserLoginControllerUnitTest {
    ...
    fun shouldLoginSuccessfullyAndReturnTokens() {
        // given
        val request = UserLoginController.LoginRequest(
            email = "test@example.com",
            password = "password123"
        )
        
        val useCaseResult = UserLoginUseCase.LoginResult(
    ...
    fun shouldReturnDifferentTokensForDifferentUsers() {
        // given
        val request1 = UserLoginController.LoginRequest(
            email = "user1@example.com",
            password = "password1"
        )
        
        val request2 = UserLoginController.LoginRequest(
            email = "user2@example.com",
            password = "password2"
        )
        
        val result1 = UserLoginUseCase.LoginResult(
            accessToken = "access1",
            refreshToken = "refresh1",
            userId = 1L
        )
        
        val result2 = UserLoginUseCase.LoginResult(
            accessToken = "access2",
    ...
    fun shouldHandleEmptyEmailAndPassword() {
        ...
        val result = UserLoginUseCase.LoginResult(
            accessToken = "token",
            refreshToken = "refresh",
            userId = 1L
        )
