...
import me.helloc.techwikiplus.service.user.adapter.inbound.web.UserSignUpController.Request
...
class UserSignUpControllerUnitTest : FunSpec({
    ...
    class FakeUserSignUpUseCase : UserSignUpUseCase {
        ...
        var lastPassword: RawPassword? = null
        var lastConfirmPassword: RawPassword? = null
        var lastNickname: Nickname? = null
