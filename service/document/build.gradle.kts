group = "${rootProject.group}.document"
...
openapi3 {
    ...
    title = "TechWikiPlus Document Service API"
    description = "Document Service API Documentation"
...
springBoot {
    mainClass.set("me.helloc.techwikiplus.service.document.DocumentApplicationKt")
}
